...
if (isset($_POST["sexo_r"])) {
    ...
    $parentesco = htmlentities(addslashes($_POST["parentesco"]));
...
if (validar_datos_vacios($parentesco)) {
...
<!------------------------------- SEGUNDO FORMULARIO [ DATOS DE LA MADRE ] ------------------------------------------------>
                        ...
                        <!--<div id="ui">-->
                            <form action="<?php htmlspecialchars($_SERVER['PHP_SELF'])?>"  method="POST" class="form-group text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 my-2">
                                            <label>Cedula:</label>
                                        <select name="nacionalidad_m" id="cedula" class="form-control" >
                                    ...
                                    <div class="row my-4">
                                        <div class="col-lg-3 ">
                                            ...
                                            <input type="text" name="fecha_nac_m" id="" class="form-control" value="<?php if(isset($fecha_nac_m)) echo $fecha_nac_m; ?>">
                                        </div>
                ...
                <option <?php if(isset($estado_civil_m)) if($estado_civil_m == '4') echo 'selected';?> value="4">Viudo/a</option>
                    ...
                    <textarea rows="3" cols="40" name="direcc_hab_m"  id="" placeholder="Direccion de Habitacion" class="form-control" ><?php if(isset($direcc_hab_m)) echo $direcc_hab_m;?></textarea>
                                        </div>
                    ...
                    <textarea rows="3" cols="40" name="direcc_trab_m"  id="" placeholder="Direccion de trabajo" class="form-control" ><?php if(isset($direcc_trab_m)) echo $direcc_trab_m;?></textarea>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="col-lg-6 my-2">
                                        ...
                                        <input type="checkbox" <?php if(isset($_POST['is_represent_m'])) if($_POST['is_represent_m'] == '1') echo 'checked';?> name="is_represent_m" value="1" id="">
                                        </div>
                                        ...
                                        <input type="radio" <?php if(isset($_POST["convivencia_m"])) if($_POST["convivencia_m"] == '1') echo 'checked';
                                        ?> name="convivencia_m" value="1" id="">

                                        <label for="convivencia_m" class="">No</label>

                                        <input type="radio" name="convivencia_m" <?php if(isset($_POST["convivencia_m"])) if($_POST["convivencia_m"] == '2') echo 'checked';
                                        ?> value="2" id="">
                                    </div>

                                    <div class="col-lg-6 my-2">
                                            <label>Seleccione si no se registrara:</label>
                                        <input type="checkbox" <?php if(isset($_POST['no_register_m'])) if($_POST['no_register_m'] == '1') echo 'checked';?> name="no_register_m" value="1" id="">
                                        </div>

                                     <div class="col-lg-6 my-2">
                                        <label>Seleccione si ya esta registrado: </label>

                                        <input type="checkbox" <?php if(isset($_POST['si_exist_m'])) if($_POST['si_exist_m'] == '1') echo 'checked';?> name="si_exist_m" value="1" id="">
                                        </div>
                ...
                <div class="row form-group text-center">    
                        ...
                        <!--<div id="ui">-->                              
                                    ...
                                    <div class="row my-4">
                                        <div class="col-lg-3 ">
                                            <label for="">Fecha de Nacimiento:</label>
                                            <input type="text" name="fecha_nac_p" id="" class="form-control" value="<?php if(isset($fecha_nac_p)) echo $fecha_nac_p; ?>">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <input type="number" name="tlf_ofic_p" id="" placeholder="Telefono de oficina" class="form-control" value="<?php if(isset($tlf_ofic_p)) echo $tlf_ofic_p;?>">
                                                         ...
                                                         <div class="col-lg-6 my-2">
                                            <label>Es el Representante?:</label>
                                        <input type="checkbox" <?php if(isset($_POST['is_represent_p'])) if($_POST['is_represent_p'] == '1') echo 'checked';?> name="is_represent_p" value="1" id="">
                                        </div>
                                        ...
                                        <input type="radio" <?php if(isset($_POST["convivencia_p"])) if($_POST["convivencia_p"] == '1') echo 'checked';
                                        ?> name="convivencia_p" value="1" id="">

                                        <label for="convivencia_p" class="">No</label>

                                        <input type="radio" name="convivencia_p" <?php if(isset($_POST["convivencia_p"])) if($_POST["convivencia_p"] == '2') echo 'checked';
                                        ?> value="2" id="">
                                    </div>

                                    <div class="col-lg-6 my-2">
                                            <label>Seleccione si no se registrara:</label>
                                        <input type="checkbox" <?php if(isset($_POST['no_register_p'])) if($_POST['no_register_p'] == '1') echo 'checked';?> name="no_register_p" value="1" id="">
                                        </div>

                                     <div class="col-lg-6 my-2">
                                        <label>Seleccione si ya esta registrado: </label>

                                        <input type="checkbox" <?php if(isset($_POST['si_exist_p'])) if($_POST['si_exist_p'] == '1') echo 'checked';?> name="si_exist_p" value="1" id="">
                                        </div>
...
<!------------------------------- CUARTO FORMULARIO [ REPRESENTANTE LEGAL ] ------------------------------------------------>
                ...
                <div class="row form-group text-center">    
                        ...
                        <!--<div id="ui">-->                              
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="radio" <?php if(isset($_POST["sexo_r"])) if($_POST["sexo_r"] == '1') echo 'checked';
                                        if(isset($sexo_r)) if($sexo_r == '1') echo 'checked';
                                        ?> name="sexo_r" value="1" id="">

                                        <label for="sexo_r" class="">Femenino</label>

                                        <input type="radio" name="sexo_r" <?php if(isset($_POST["sexo_r"])) if($_POST["sexo_r"] == '2') echo 'checked';
                                         if(isset($sexo_r)) if($sexo_r == '2') echo 'checked';
                                    ...
                                    <div class="row my-4">
                                        <div class="col-lg-3 ">
                                            <label for="">Fecha de Nacimiento:</label>
                                            <input type="text" name="fecha_nac_r" id="" class="form-control" value="<?php if(isset($fecha_nac_r)) echo $fecha_nac_r; ?>">
                                        </div>
                ...
                <option <?php if(isset($estado_civil_r)) if($estado_civil_r == '4') echo 'selected';?> value="4">Viudo/a</option>
                    ...
                    <textarea rows="3" cols="40" name="direcc_trab_r"  id="" placeholder="Direccion de trabajo" class="form-control" ><?php if(isset($direcc_trab_r)) echo $direcc_trab_r;?></textarea>
                                    ...
                                    <input type="text" name="parentesco" id="" placeholder="Parentesco" class="form-control" value="<?php if(isset($parentesco)) echo $parentesco;?>">
                                        </div>
          ...
          <!--</div>-->
                                     ...
                                     <div class="col-lg-6 my-2">
                                        ...
                                        <input type="checkbox" <?php if(isset($_POST['si_exist_r'])) if($_POST['si_exist_r'] == '1') echo 'checked';?> name="si_exist_r" value="1" id="">
                                        </div>
                                <a href="reg-estudiante-1.php" class="btn btn-primary col-lg-2 btn-lg">VOLVER</a> 


                            <button type='submit' class="btn btn-primary btn-block btn-lg"value="datos_student" name ='datos_pers_estd'>Continuar</button>
