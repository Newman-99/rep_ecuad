...
if (validar_datos_vacios($desc_lleg_retir_transp)) {
 ...
 /* regist_data_salud_student('V19913903883',
             $enfer_cron, 
             $descrip_enfer_cron, 
             $problem_visual, 
             $descrip_problem_visual,
       ...
       /*  register_movilidad_student('V19913903883',$lleg_retir,$descrip_lleg_retir,$lleg_retir_transp,$desc_lleg_retir_transp);*/
                            ...
                            <form action="<?php htmlspecialchars($_SERVER['PHP_SELF'])?>"  method="POST" class="form-group text-center">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-lg-12 my-4">
                                            ...
                                            <?php if(isset($_POST["hermanos"])) if($_POST["hermanos"] == '1') echo 'checked';?>
                                          >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="hermanos" id="" value="0"
                                    <?php if(isset($_POST["hermanos"])) if($_POST["hermanos"] == '0') echo 'checked';?>
                                            ><br>
                                      ...
                                      <div class="col-lg-12 my-4">
                                       ...
                                       <?php if(isset($_POST["enfer_cron"])) if($_POST["enfer_cron"] == '1') echo 'checked';
                                         ?>
                                            >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="enfer_cron" id="" value="0"
                                       <?php if(isset($_POST["enfer_cron"])) if($_POST["enfer_cron"] == '0') echo 'checked';
                                         ?>
                                            ><br>
                                            <label for="" class="my-4">Especifique</label>
                                      ...
                                      <div class="col-lg-12 my-4">
                                       ...
                                       <?php if(isset($_POST["problem_visual"])) if($_POST["problem_visual"] == '1') echo 'checked';
                                         ?>
                                            >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="problem_visual" id="" value="0"
                                       <?php if(isset($_POST["problem_visual"])) if($_POST["problem_visual"] == '0') echo 'checked';
                                         ?>
                                            ><br>
                                            <label for="" class="my-4">Especifique</label>
                                      ...
                                      <div class="col-lg-12 my-4">
                                       ...
                                       <?php if(isset($_POST["problem_audi"])) if($_POST["problem_audi"] == '1') echo 'checked';
                                         ?>
                                            >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="problem_audi" id="" value="0"
                                       <?php if(isset($_POST["problem_audi"])) if($_POST["problem_audi"] == '0') echo 'checked';
                                         ?>
                                      ...
                                      <div class="col-lg-12 my-4">
                                       ...
                                       <?php if(isset($_POST["alergias"])) if($_POST["alergias"] == '1') echo 'checked';
                                        ;?>
                                            >
                                            
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="alergias" id="" value="0"
                                       <?php if(isset($_POST["alergias"])) if($_POST["alergias"] == '0') echo 'checked';
                                        ;?>
                                            ><br>
                                            <label for="" class="my-4">Especifique</label>
                                      ...
                                      <div class="col-lg-12 my-4">
                                       ...
                                       <?php if(isset($_POST["condic_especif"])) if($_POST["condic_especif"] == '1') echo 'checked';
                                         ;?>
                                            >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="condic_especif" id="" value="0"
                                       <?php if(isset($_POST["condic_especif"])) if($_POST["condic_especif"] == '0') echo 'checked';
                                         ;?>
                                            ><br>
                                            <label for="" class="my-4">Especifique</label>
                                      ...
                                      <div class="col-lg-12 my-4">
                                       ...
                                       <?php if(isset($_POST["vacunas"])) if($_POST["vacunas"] == '1') echo 'checked';
                                         ?>
                                            >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="vacunas" id="" value="0"
                                       <?php if(isset($_POST["vacunas"])) if($_POST["vacunas"] == '0') echo ' checked ';
                                         ?>
                                            ><br>
                        ...
                        <div class="col-lg-12 form-group text-center">
                            <div id="ui">
                                    <div class="row">
                                       ...
                                       <?php if(isset($_POST["medicacion"])) if($_POST["medicacion"] == '1') echo 'checked';
                                         ?>
                                                >
                                                <label for="" class="radio-inline mx-1"
                                                >No:</label>
                                                <input type="radio" name="medicacion" id="" value="0"
                                       <?php if(isset($_POST["medicacion"])) if($_POST["medicacion"] == '0') echo 'checked';
                                         ?>
                                                >
                                       ...
                                       <?php if(isset($_POST["anex_infor"])) if($_POST["anex_infor"] == '1') echo 'checked';
                                        ?>
                                                >
                                                <label for="" class="">No:</label>
                                                <input type="radio" name="anex_infor" id="" value="0"
                                       <?php if(isset($_POST["anex_infor"])) if($_POST["anex_infor"] == '0') echo 'checked';
                                        ?>
                                                >
                                        </div>
                        ...
                        <div class="col-lg-12 form-group text-center">
                            <div id="ui">
                                    <div class="row">
                                       ...
                                       <?php if(isset($_POST["lleg_retir"])) if($_POST["lleg_retir"] == '1') echo 'checked';
                                         ?>
                                            >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="lleg_retir" id="" value="0"
                                       <?php if(isset($_POST["lleg_retir"])) if($_POST["lleg_retir"] == '0') echo 'checked';
                                         ?>
                                            ><br>
                                            <label for="" class="my-4">Especifique</label>
                                       ...
                                       <?php if(isset($_POST["lleg_retir_transp"])) if($_POST["lleg_retir"] == '1') echo 'checked';
                                         ?>
                                            >
                                            <label for="" class="">No:</label>
                                            <input type="radio" name="lleg_retir_transp" id="" value="1"
                                       <?php if(isset($_POST["lleg_retir_transp"])) if($_POST["lleg_retir"] == '0') echo 'checked';
                                         ?>
                                            ><br>
                                            <label for="" class="my-4">Especifique</label>
    ...
    <!--------------------------- OCTAVO FORMULARIO [ Persona autorizada a retirar el estudiante de la institucion ] -->
        ...
        <input type="text" name="apellido_m_pr" id="" placeholder="Apellido Materno" class="form-control" value="<?php if(isset($apellido_m_pr)) echo $apellido_m_pr; ?>">
            ...
            <br><br>
                                          ...
                                          <input type="radio" <?php if(isset($_POST["sexo_pr"])) if($_POST["sexo_pr"] == '1') echo 'checked';
                                          if(isset($sexo_pr)) if($sexo_pr == '1') echo 'checked';
                                          ?> name="sexo_pr" value="1" id="">

                                          <label for="sexo_pr" class="">Femenino</label>

                                          <input type="radio" name="sexo_pr" <?php if(isset($_POST["sexo_pr"])) if($_POST["sexo_pr"] == '2') echo 'checked';
                                        ...
                                        <input type="checkbox" <?php if(isset($si_exist_pr)) if($si_exist_pr == '1') echo 'checked';?> name="si_exist_pr" value="1" id="">
                                        </div>
